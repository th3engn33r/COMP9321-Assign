...
public class DBConnectionFactoryTest extends TestCase {
	 ...
	 */
	 ...
	 public void setUp() throws Exception {
         ...
         ref.add(new StringRefAddr("driverClassName", "org.mysqldb.jdbcDriver"));
         //TODO: change the following to your own setting
         ref.add(new StringRefAddr("url", "jdbc:mysql://localhost:3306/"));
         ref.add(new StringRefAddr("username", "root"));
         ref.add(new StringRefAddr("password", "Mysql"));
         ic.bind("java:/comp/env/jdbc/MySQL", ref);
    }
